...
def send_message():
    ...
    print(f"Inserting message: Sender ID: {sender_id}, Recipient ID: {recipient_id}, Encrypted Message: {encrypted_message}")
...
def retrieve_messages():
    ...
    # Display encrypted messages directly (as decryption is not required)
    messages = [{'sender': sender_id, 'message': encrypted_message, 'timestamp': timestamp}
